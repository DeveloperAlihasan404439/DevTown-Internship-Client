        ...
        <div className="flex flex-row flex-wrap-reverse bg-[#07163d] p-4 rounded justify-center mt-8">
			<div className="flex flex-col justify-center w-full px-8 mx-6 my-12 bg-gradient-to-t  from-[#07163d] to-[#3D8AD0] text-white text-center rounded-md md:w-96 lg:w-80 xl:w-64  ">
				...
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					...
					<a rel="noopener noreferrer" href="#" title="Twitter" className=" hover:">
					...
					<a rel="noopener noreferrer" href="#" title="LinkedIn" className=" hover:">
					...
					<a rel="noopener noreferrer" href="#" title="GitHub" className=" hover:">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5">
...
export default AllUsersHomeCrad;